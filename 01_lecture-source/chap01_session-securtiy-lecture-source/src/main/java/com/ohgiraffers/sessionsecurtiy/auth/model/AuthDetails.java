package com.ohgiraffers.sessionsecurtiy.auth.model;
...
public class AuthDetails implements UserDetails {
    ...
    *  UsernamePasswordAuthenticationToken 과 사용자의 아이디를 비교할때 사용한다*/
    @Override
    ...
    *  false 이면 해당 계정을 사용할 수 없다*/
    ...
    /*필기.
    *  잠겨있는 계정을 확인하는 메소드 false 이면 해당 계정을 사용할수없다
    *  비밀 번호 반복 실패로 일시적인 게정 lock  인 경우 혹은 오랜시간 비접속으로 휴면 처리*/
    @Override
    ...
    /*필기.
    *  탈퇴계정 여부를 표현하는 메소드 false 이면 해당 계정을 사용할수없다*/
    @Override
